package com.example.smsproject.service;

import com.example.smsproject.client.JsonReqClient;
import com.example.smsproject.entity.BaseRequest;
import com.example.smsproject.entity.SmsProperties;
import com.example.smsproject.entity.UcpassSmsProperties;
import com.example.smsproject.entity.UcpassSmsRequest;
import com.example.smsproject.exception.SmsException;
import com.example.smsproject.utils.SmsCacheUtils;
...
public class UcpassSmsService implements SmsService {
    ...
    public UcpassSmsService(SmsProperties smsProperties) {
        ...
        ucpassSmsProperties.setRestServer("open.ucpaas.com");

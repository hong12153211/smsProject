...
import com.example.smsproject.utils.OkHttpClientUtil;
import com.example.smsproject.utils.RequestEncoder;
import com.example.smsproject.utils.SignTypeEnum;
...
public class SubMailClient {
    ...
    protected String getTimestamp() {
        ...
        try {
            ...
            Timestamp timestamp = GsonUtils.gsonToBean(json, Timestamp.class);
